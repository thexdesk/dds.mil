...
const PROJECT_SASS_SRC = './src/assets/uswds-theme';

// Project Sass source directory
const PROJECT_USWDS_SASS_SRC = './src/assets/uswds-sass';

// Images destination
const IMG_DEST = './src/assets/img/layout';

// Fonts destination
const FONTS_DEST = './src/assets/fonts';

// Javascript destination
const JS_DEST = './src/assets/js/vendor';

// Compiled CSS destination
const CSS_DEST = './src/assets/uswds';
